...
export const FormRendererFieldInfo: FC<FormRendererFieldInfoProps> = ({ content }) => {
	...
	return visible ? (
		<div role="alertdialog" aria-labelledby="alert" className="m-alert">
			<button className="a-button-transparent has-icon m-alert__close" aria-label="Close" onClick={() => setVisibility(false)}>
